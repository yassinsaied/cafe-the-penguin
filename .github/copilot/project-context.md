...
```css
--color-gold: #c9a84c /* Primary accent */ --color-gold-light: #e8d5a3 /* Light accent */
  --color-espresso: #120d07 /* Primary bg (dark) */ --color-brown: #3d1f00 /* Secondary bg */
  --color-muted: #9a8f80 /* Muted text */ --color-cream: #c8bba6 /* Light text */;
```
